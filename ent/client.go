...
import (
	...
	"github.com/karim-w/techunicorn-task/ent/migrate"
...
// QueryAttendingDoctor queries the AttendingDoctor edge of a Slot.
func (c *SlotClient) QueryAttendingDoctor(s *Slot) *UserQuery {
...
// QueryPatient queries the patient edge of a Slot.
func (c *SlotClient) QueryPatient(s *Slot) *UserQuery {
	query := &UserQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := s.ID
		step := sqlgraph.NewStep(
...
// QueryAttending queries the Attending edge of a User.
func (c *UserClient) QueryAttending(u *User) *SlotQuery {
...
// QueryVisiting queries the Visiting edge of a User.
func (c *UserClient) QueryVisiting(u *User) *SlotQuery {
	query := &SlotQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
